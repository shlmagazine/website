    ...
    return preg_replace_callback('/
        ...
        function ($matches) {
            ...
            return match (true) {
                ...
                !empty($matches['start_of_quote']) => $matches['start_of_quote_start_tag'] . '“' . $base_ellipsis . $nbsp . $matches['start_of_quote_character'],
                !empty($matches['punctuation']) => $base_ellipsis . $nbsp . $matches['punctuation_mark'],
