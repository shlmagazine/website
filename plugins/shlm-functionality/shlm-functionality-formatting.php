...
function cmos_ellipses_everywhere($text) {
    return preg_replace_callback('/
            ...
            # Ellipsis begins an h1 heading title
            |(?<start_of_h1>
                (?<start_of_h1_start_tags><.*>)*
                <h1(?<start_of_h1_attributes>.*)>
                \ *…\ *(?<start_of_h1_character>.)
            )
        ...
        function ($matches) {
            ...
            return match (true) {
                ...
                !empty($matches['start_of_h1']) => $matches['start_of_h1_start_tags'] . '<h1' . $matches['start_of_h1_attributes'] . '>' . $base_ellipsis . $nbsp . $matches['start_of_h1_character'],
