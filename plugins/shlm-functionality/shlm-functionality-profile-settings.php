...
function add_social_media_fields($user) {
    ...
    <table class="form-table">
        ...
        <tr>
            <th><label for="youtube-link">YouTube</label></th>
            <td>
                <input type="text" name="youtube_link" id="youtube-link" value="<?php echo esc_attr( get_the_author_meta( 'youtube_link', $user->ID ) ); ?>" class="regular-text" />
            </td>
        </tr>
        <tr>
